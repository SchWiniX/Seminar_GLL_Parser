...
USET:
	...
	printf("]%d], %d, (%c, %d), %d)", set_info->U_set[i].alternative_end_idx, set_info->U_set[i].input_idx, set_info->U_set[i].gss_node_idx.rule, set_info->U_set[i].gss_node_idx.input_idx, set_info->U_set[i].label_type);
